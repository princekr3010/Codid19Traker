...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tvCases,  tvRecovered, tvCritical, tvActive, tvTodayCases, tvTotalDeath, tvTodayDeath, tvAffectedCountries;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTotalDeath = findViewById(R.id.tvTotalDeathes);
